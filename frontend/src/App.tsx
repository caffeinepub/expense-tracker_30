...
import { Heart, Loader2, IndianRupee, LogIn, User } from 'lucide-react';
        ...
        <div className="w-full max-w-xs space-y-4">
          <div className="bg-card rounded-2xl border border-border p-5 space-y-3">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-foreground font-medium">Track daily expenses easily</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                <span className="text-sm">📊</span>
              </div>
              <p className="text-sm text-foreground font-medium">View history & reports</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                <span className="text-sm">💸</span>
              </div>
              <p className="text-sm text-foreground font-medium">Manage repayments</p>
            </div>
          </div>
